        ...
        <x-slot name="header">
            <div class="flex justify-between">
                ...
                @if (Route::has('login'))
                    <div class="">
                        <a href="{{ route('login') }}"
                            class="font-semibold text-gray-600 hover:text-green-700 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                            in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="ml-4 font-semibold text-gray-600 hover:text-green-700 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
                        @endif
            ...
            @if ($suggestions)
                <ul class="space-y-6">
                    @foreach ($suggestions as $suggestion)
                        <li
                            class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 flex flex-wrap md:flex-nowrap items-center gap-2 md:gap-4">
